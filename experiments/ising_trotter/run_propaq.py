#!/usr/bin/env python3
"""Run propaq, both Pauli and Majorana basis, on every saved ising_trotter circuit.

Majorana basis reaches this spin model through Jordan-Wigner (MajoranaCircuit.from_qiskit
