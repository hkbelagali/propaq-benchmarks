#!/usr/bin/env python3
"""Run propaq, both Pauli and Majorana basis, on every saved ucj_h2 circuit.

Majorana basis reaches this molecular ansatz through Jordan-Wigner (MajoranaCircuit.from_qiskit
