#!/usr/bin/env python3
"""Run propaq, both Pauli and Majorana basis, on every saved qaoa_maxcut circuit.

Majorana basis reaches this QAOA circuit through Jordan-Wigner (MajoranaCircuit.from_qiskit
