#!/usr/bin/env julia
# Run PauliPropagation.jl (Pauli basis) on every saved qaoa_maxcut circuit.
#
...
#
# Usage: julia --project=<julia_env> -t 64 experiments/qaoa_maxcut/run_pauli_propagation_jl.jl
