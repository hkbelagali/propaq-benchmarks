#!/usr/bin/env python3
"""Run propaq, both Pauli and Majorana basis, on every saved random_circuit circuit.

Majorana basis reaches this random circuit through Jordan-Wigner (MajoranaCircuit.from_qiskit
