#!/usr/bin/env python3
"""Run propaq, both Pauli and Majorana basis, on every saved random_near_clifford circuit.

Majorana basis reaches this near-Clifford circuit through Jordan-Wigner
(MajoranaCircuit.from_qiskit on the same qubit circuit), the same qubit circuit the Pauli
basis above consumes, giving a same-package, same-input Pauli-vs-Majorana comparison point
in addition to the cross-package one.
"""
