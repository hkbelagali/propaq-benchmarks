#!/usr/bin/env julia
# Run PauliPropagation.jl (Pauli basis) on every saved random_fermionic_circuit circuit.
#
...
#
# Usage: julia --project=<julia_env> -t 64 experiments/random_fermionic_circuit/run_pauli_propagation_jl.jl
